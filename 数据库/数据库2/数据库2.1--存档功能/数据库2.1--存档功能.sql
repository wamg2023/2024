...
insert  into `graph`(`graph_seq_id`,`graph_id`,`room_status`,`room_id`,`east_room_id`,`west_room_id`,`south_room_id`,`north_room_id`) values (1,1,1,1,NULL,NULL,NULL,NULL);
...
insert  into `inventory`(`inventory_seq_id`,`inventory_id`,`item_id`,`item_num`) values (1,1,1,2);
...
insert  into `role`(`role_id`,`type`,`inventory_id`,`role_attribute_id`,`skill_table_id`,`role_saved_id`) values (1,1,1,1,1,1);
...
insert  into `role_attribute`(`role_attribute_id`,`hit_point`,`magic_point`,`attack`,`defence`,`speed`,`role_load`) values (1,100,100,10,10,10,100);

/*Table structure for table `role_saved` */
...
/*Data for the table `role_saved` */

insert  into `role_saved`(`role_saved_id`,`role_status_id`,`graph_id`) values (1,1,1);
...
insert  into `role_status`(`role_status_id`,`hit_point`,`magic_point`,`attack`,`defence`,`speed`) values (1,90,90,10,10,10);
...
insert  into `room`(`room_id`,`name`,`room_event_id`) values (1,'广场大厅',1);
...
insert  into `user`(`account`,`password`,`player_id`) values ('1','111',1);
...
/* Trigger structure for table `role_saved` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `after_role_saved_delete` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `after_role_saved_delete` AFTER DELETE ON `role_saved` FOR EACH ROW BEGIN  
