...
/* Trigger structure for table `role_attribute` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `after_role_attribute_delete` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `after_role_attribute_delete` AFTER DELETE ON `role_attribute` FOR EACH ROW BEGIN  
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `after_room_delete` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `after_room_delete` AFTER DELETE ON `room` FOR EACH ROW BEGIN  
    DELETE FROM inventory WHERE inventory_id = OLD.inventory_id;  
END */$$
